                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-5">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-600 mb-1">
                                    Alamat <span className="text-gray-400 text-normal">(opsional)</span>
                                </label>
                                <textarea
                                    rows="3"
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 text-center">
                        ...
                        <p className="text-gray-500 mb-6">
                            Data <span className="font-semibold text-gray-700">{deleteTarget.nama}</span>
                            akan dihapus permanen. Riwayat transaksi tetap tersimpan.
                        </p>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[85vh] overflow-y-auto">
                        ...
                        <div className="flex items-center gap-4 mb-5">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500">📞 {historyData.pelanggan.no_hp}</p>
                        ...
                        <button
                            ...
                            className="mt-5 w-full py-3 border rounded-xl hover:bg-gray-50 font-medium">
                            Tutup
                        </button>
                    </div>
                </div>
