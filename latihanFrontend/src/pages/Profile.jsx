...
function KameraModal({ onCapture, onClose }) {
    ...
    // Start kamera saat mount / ganti facingMode / retry
    useEffect(() => {
        let isActive = true;
                    ...
                    <div className="flex flex-col items-center gap-4 pb-5">
                        ...
                        <div className="flex gap-3 px-5 w-full">
                            ...
                            <button
                                ...
                                disabled={!ready}
                                className="flex-1 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-40 transition font-bold text-sm"
                            >
                                📷 Ambil Foto
                            </button>
                        </div>
...
function Profil() {
    ...
    const handleSaveProfil = async () => {
        ...
        try {
            const res = await api.put('/profile', formProfil);
    ...
    const handleSavePassword = async () => {
        ...
        try {
            await api.put('/profile/password', formPassword);
    ...
    const uploadFoto = async (file, localPreview) => {
        ...
        try {
            ...
            fd.append('foto', file);
            const res = await api.post('/profile/foto', fd, {
                ...
                <div className="bg-white rounded-2xl shadow p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full border rounded-xl px-4 py-3 pr-12 focus:ring-2 focus:outline-none ${formPassword.password_confirmation && formPassword.password !== formPassword.password_confirmation
                        ...
                        <button
                            ...
                            className="w-full bg-gray-900 hover:bg-gray-800 text-white py-3.5 rounded-2xl font-medium transition disabled:opacity-40"
                        >
